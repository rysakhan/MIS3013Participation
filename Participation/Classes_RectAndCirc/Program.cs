...
namespace Classes_RectAndCirc
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            myRectangle.Width = 5;
            Console.WriteLine("The area of a rectangle with" + myRectangle.Width + myRectangle.Length + 
                " is" + myRectangle.CalculateArea() + "and a periment of " + myRectangle.CalculatePerimeter());
